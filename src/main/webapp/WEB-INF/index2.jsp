...
<%-- <div class="leftBar"><%@ include file="template/header.jsp" %></div> --%>
<%-- 	<div class="leftBar"><jsp:include page="${ param.body }" /></div> --%>
<%-- 	<div class="leftBar"><%@ include file="template/footer.jsp" %></div> --%>