				...
				<div class="row border rounded-3 p-1 text-center d-flex justify-content-center m-0">
					<div class="row border-bottom pb-2 mb-2">
						<div class="col-4 text-start p-0">
							...
							<div class="col-12">
								<i class="fa fa-eye" aria-hidden="true"></i>&nbsp;&nbsp;${store.storeReadCount }
							</div>
							<div class="col-12">
								<i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;&nbsp;${store.storeReviewCount }
							</div>
							<div class="col-12">
								<i class="fa fa-heart" aria-hidden="true"></i>&nbsp;&nbsp;${store.storeBookmarks }
							</div>
						</div>
						<div class="col-8">
							<div class="row">
								...
								<div class="col border rounded-3 p-1 m-1">
									<img src="/yameokja/resources/IMG/store/${ store.storeFileMenu }" class="img-thumbnail rounded float-start" alt="...">
								</div>

								<input type="hidden" id="storeLatitude" value="${store.storeLatitude }"> <input type="hidden" id="storeLongitude" value="${store.storeLongitude }">
						...
						<div class="col-6 border-start ps-4">
							...
							<div class="row">
								...
								<div class="col-12 text-end m-0 p-0 d-inline">
									...
									<c:if test="${result}">
										<a class="fa fa-heart bookmarks-on text-danger"
											id="btnStoreBookmarks" href="javascript:;"
											onclick="location.href = 'bookmarksUpdate?memberId=${ sessionScope.memberId }&storeNo=${ store.storeNo }' "></a>
									</c:if>
									<c:if test="${!result}">
										<a class="fa fa-heart-o bookmarks-off"
											id="btnStoreBookmarks"  href="javascript:;"
											onclick="location.href = 'bookmarksUpdate?memberId=${ sessionScope.memberId }&storeNo=${ store.storeNo }' "></a>
									</c:if>
		
									<i class="fa fa-link" aria-hidden="true"
										onclick="clip(); return false;"></i> <i class="fa fa-bell"
										aria-hidden="true"></i>
								</div>
							</div>
						</div>
